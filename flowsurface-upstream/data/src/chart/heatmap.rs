...
pub enum HeatmapStudy {
    ...
    /// Resting liquidity walls with anti-spoof persistence (from the confluence detector).
    LiquidityWalls,
}
...
impl std::fmt::Display for HeatmapStudy {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            ...
            HeatmapStudy::LiquidityWalls => write!(f, "Liquidity Walls"),
        }
    }
}
