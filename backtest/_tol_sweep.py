...
print(f"{'LEVEL_TOL':<12}  {'n_IS':>5}  {'WR_IS':>6}  {'n_OOS':>5}  {'WR_OOS':>6}  {'AvgR_OOS':>9}  {'tpd':>5}  {'Capital':>10}")
print('-'*85)
for tol in [0.004, 0.005, 0.006, 0.007, 0.008, 0.010, 0.012, 0.015]:
    trades, cap = simulate(df, level_tol=tol)
    ...
    print(f"{tol*100:.2f}%        {ni:>5}  {wi:>5.1f}%  {no:>5}  {wo:>5.1f}%  {ao:>+.3f}      {no/90:>4.1f}  ${cap:>9,.0f}")
